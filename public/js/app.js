...
window.invOpenComponents         = Inventory.invOpenComponents;
window.invCloseComponents        = Inventory.invCloseComponents;
window.invOnComponentSearch      = Inventory.invOnComponentSearch;
window.invAddComponent           = Inventory.invAddComponent;
window.invRemoveComponent        = Inventory.invRemoveComponent;
